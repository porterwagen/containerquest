...
export default function Landing() {
  ...
  return (
    <main className="mx-auto max-w-[1180px] px-5 py-7 sm:px-8">
      {/* Same segmented control as AppHeader on /learn and /dashboard. */}
      <nav className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1 rounded-lg border border-edge bg-panel p-1">
            <Link
              href="/learn"
              className="rounded-md px-3 py-1.5 text-[13px] text-ink-faint transition-colors hover:text-ink-dim"
            >
              Learn
            </Link>
            <Link
